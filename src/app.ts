...
import router from "./router";
       // ← import
import { metricsService } from "./utility/metrics.service"; // ← import
...
import monitorRouter from "./utility/metricsMiddleware";
...
app.use((req, res, next) => {
  ...
  res.on("finish", () => {
    ...
    metricsService.recordRequest(latency, success);
  });
  next();
});
